...
const registerSchema = z.object({
  ...
  // Токен приглашения из ссылки в письме. Без него в схеме Zod вырезал бы поле
  // из req.body (объект по умолчанию отбрасывает лишние ключи) — и регистрация
  // по приглашению молча превращалась бы в обычную.
